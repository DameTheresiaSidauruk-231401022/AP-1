...
int main() {
    ...
    // Accessing Elements in Array and printing them
    for (int i = 0; i < 5; i++) {
        cout << nama[i] << endl;
    }
    ...
    // Accessing and printing elements of multidimensional array
    for (int i = 0; i < 2; i++) {
        for (int j = 0; j < 3; j++) {
            cout << matrix[i][j] << " ";
        }
    ...
    // Accessing and printing individual characters of the string
    ...
    cin >> n;  // Input banyak mahasiswa

    float nilai[n];
    for (int i = 0; i < n; i++) {
        cout << "Masukkan nilai mahasiswa ke " << i + 1 << " : ";  
        cin >> nilai[i];  // Input nilai mahasiswa
    }

    for (int i = 0; i < n; i++) {
        cout << "Nilai mahasiswa ke " << i + 1 << " : " <<  nilai[i] << endl;  // Menampilkan nilai mahasiswa
    }
    ...
    for (int i = 0; i < sizeof(nama_karyawan) / sizeof(string); i++) {
        cout << nama_karyawan[i] << endl;  // Menampilkan nama karyawan
    }
    ...
    for (int i = 0; i < 2; i++) {
        for (int j = 0; j < 2; j++) {
            ...
            cin >> matriks1[i][j];   // Input elemen matriks pertama
        }
    }
    ...
    for (int i = 0; i < 2; i++) {
        for (int j = 0; j < 2; j++) {
            cout << "Masukkan elemen baris " << i + 1 << " kolom " << j + 1 << " : ";
            cin >> matriks2[i][j];   // Input elemen matriks kedua
        }
    }
